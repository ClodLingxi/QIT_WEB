...
<dl class="leftmenu">
  ...
  <dd>
    <div class="title"><span><img src="${pageContext.request.contextPath}/admin/images/leftico04.png" /></span>系统管理</div>
    <ul class="menuson">
      <li><cite></cite><a href="${pageContext.request.contextPath}/admin/manage/userOnline.jsp" target="rightFrame">在线用户</a><i></i></li>
    </ul>
  </dd>
  <dd>
    <div class="title"><span><img src="${pageContext.request.contextPath}/admin/images/leftico04.png" /></span>密码修改</div>
  </dd>
</dl>
</body>
</html>
