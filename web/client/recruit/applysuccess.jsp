...
<div class="applyit-content-box">
  ...
  <div class="it-more-actions">
    ...
    <div class="it-comment-btn"> <a href="../index.jsp" class="app_btn"> <span class="tn-icon it-icon-arrow"></span><span class="tn-button-text">申请其他职位</span> </a> </div>
  </div>
  <div class="it-secondary-link">
    <ul>
      <li><span class="it-icon-view"></span> <a href="../applicant/jobApply.jsp" title="查看我的职位申请">查看我的职位申请</a> </li>
      <li><span class="it-icon-modify"></span> <a href="../applicant/resume.jsp" title="修改我的简历">修改我的简历</a> </li>
    </ul>
  </div>
</div>
