...
<script type="text/javascript">
	...
	// document.getElementById('resumePicture').addEventListener('change', function(event) {
...
<body>
	...
	<div class="resume_con">
		...
		<div class="user_operate">
			<ul style="float: left">
			  <li> <a href="${pageContext.request.contextPath}/ResumeClient">我的简历</a></li>
              <li class="tn-tabs-selected"> <a href="${pageContext.request.contextPath}/client/applicant/jobApply.jsp">我的申请</a></li>
			</ul>
			<div class="clear"></div>
		</div>
		<!--主体部分-->
		<div class="resume_main">
			...
			<div class="resume_left">
				...
				<div class="all_resume">
					<!--------------------- 简历照片修改------------------------->
					<form action="${pageContext.request.contextPath}/ResumeClient?type=uploadPicture" method="post"
						enctype="multipart/form-data" onsubmit="return validate();">
						<div class="table_style" style="margin-left: 150px;">
							<div class="uploade">
								<div align="center">
									<img id="imagePreview" src="${pageContext.request.contextPath}/client/applicant/images/anonymous.png" width="150" height="150">
									<p>&nbsp;</p>
									<input name="resumePicture" id="resumePicture" type="file" value="上传照片">
								</div>
							</div>
							<div class="clear"></div>
							<div class="he"></div>
