...
<%
	...
	if (passport != null){
		Object userID = Tomcat.userManager.validate(passport);
		if (userID != null){
			TbResume tbResume = Tomcat.resumeMapper.selectByUserId((Integer) userID);
			if (tbResume != null){
				request.setAttribute("resume", tbResume);
				String resume_date = Tomcat.dataFormatter.format(tbResume.getResumeBirthday());
				request.setAttribute("resume_date", resume_date);
			}
		}
	}
%>
...
<div class="resume_con">
	...
	<div class="user_operate">
		<ul style="float:left">
			<li><a href="${pageContext.request.contextPath}/client/applicant/resume.jsp" class="active">我的简历</a></li>
    ...
    <div class="resume_main">
	    ...
	    <div class="resume_left">
			<div class="resume_title">
				...
				<div class="btn"><a href="${pageContext.request.contextPath}/client/applicant/resumeBasicinfoUpdate.jsp">修改</a></div>
			</div>
				...
				<div class="table_style">
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume.resumeName}</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume.resumeGender}</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume_date}</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume.resumePhone}</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume.resumeEmail}</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume.resumeTarget}</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resume.resumeExperience}</td>
					  </tr>
					</table>
					<div class="he"></div>
				</div>
    	...
    	<!--右边-->
		<iframe src="${pageContext.request.contextPath}/client/applicant/resume_right.jsp" width="290" height="650" scrolling="no" frameborder="0"></iframe>
